...
public class ViewDoctorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtDoctor.setAutoCreateRowSorter(true);
        jtDoctor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void showDocDetails()
{
    try
    {
        ArrayList<UserDoctorPojo> docList= DoctorDao.getAllDoctor();
        Object  cols[]=new Object[4];
        DefaultTableModel dt =(DefaultTableModel)jtDoctor.getModel();
        for(UserDoctorPojo e: docList)
        {
            cols[0]=e.getUserId();
            cols[1]=e.getDoctorId();
            cols[2]=e.getQualification();
            cols[3]=e.getSpecialist();
            dt.addRow(cols);
        }
